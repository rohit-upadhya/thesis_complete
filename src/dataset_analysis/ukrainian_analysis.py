...
def dump_json(path, data):
    with open(os.path.join(path,"ukrainian.json"), "w+") as file:
...
if __name__=="__main__":
    train_data_path = "/srv/upadro/dataset/ukrainian/unseen_queries/train"
    test_data_path = "/srv/upadro/dataset/ukrainian/unseen_queries/test"
    unique_query_test_data_path = "/srv/upadro/dataset/ukrainian/unseen_queries/unique_query_test"
    val_data_path = "/srv/upadro/dataset/ukrainian/unseen_queries/val"
    train_test_val = "/srv/upadro/dataset/ukrainian/unseen_queries/train_test_val"
