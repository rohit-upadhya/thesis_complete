...
class ContrastiveTrainer:
    ...
    def main(self):
        ...
        train_sampler = BatchSampler(dataset=train_dataset, batch_size=self.batch_size)
        val_sampler = BatchSampler(dataset=val_dataset, batch_size=self.batch_size)
...
if __name__ == "__main__":
    data_file = 'src/models/single_datapoints/common/test.json'
