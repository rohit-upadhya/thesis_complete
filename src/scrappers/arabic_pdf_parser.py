...
def filter_results(results):
    ...
    for result in results:
        ...
        if size >= 19.0 :#or "Calibri-Bold" in font or link is not None or "§" in text:
...
if __name__ == "__main__":
    ...
    text_file_output =  os.path.join("output","arabic_results_new.txt")           
    with open(text_file_output, "w+") as file:
        for result in combined_links:
