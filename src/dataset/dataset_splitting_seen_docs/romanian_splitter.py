...
logging.basicConfig(filename='romanian_splitter.log', level=logging.INFO)
...
if __name__=="__main__":
    ...
    train_base_path = "/srv/upadro/dataset/romanian/unseen_docs/train"
    test_base_path = "/srv/upadro/dataset/romanian/unseen_docs/test"
