...
logging.basicConfig(filename='french_splitter.log', level=logging.INFO)
...
if __name__=="__main__":
    ...
    train_base_path = "/srv/upadro/dataset/french/unseen_docs/train"
    test_base_path = "/srv/upadro/dataset/french/unseen_docs/test"
