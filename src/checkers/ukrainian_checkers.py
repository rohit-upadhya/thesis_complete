...
if __name__=="__main__":
    output_data_path = "output/ukrainian/jsons/"
    files = []
    ...
    for file in files:
        ...
        output_file =  os.path.join("output", "ukrainian", "relevant_jsons", f"{file_name}_analysis.json")
        with open(output_file, 'w') as file:
            json.dump(usable, file, indent=4, ensure_ascii=False,)
        meta_data_file = os.path.join("output", "ukrainian", "analysis", "metadata_analysis.txt")
