...
if __name__=="__main__":
    ...
    train_base_path = "/srv/upadro/dataset/french/unseen_queries/train"
    train_test_val_base_path = "/srv/upadro/dataset/french/unseen_queries/train_test_val"
    val_base_path = "/srv/upadro/dataset/french/unseen_queries/val"
    test_base_path = "/srv/upadro/dataset/french/unseen_queries/test"
    unique_query_test_base_path = "/srv/upadro/dataset/french/unseen_queries/unique_query_test"
    for file in files:
