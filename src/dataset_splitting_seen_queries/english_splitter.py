...
if __name__=="__main__":
    input_data_path = "output/english/done"
    files = []
    for (dirpath, dirnames, filenames) in os.walk(input_data_path):
        for filename in filenames:
            if "json" in filename:
                files.append(os.path.join(dirpath, filename))
    train_base_path = "/srv/upadro/dataset/english/unseen_queries/train"
    train_test_val_base_path = "/srv/upadro/dataset/english/unseen_queries/train_test_val"
    val_base_path = "/srv/upadro/dataset/english/unseen_queries/val"
    test_base_path = "/srv/upadro/dataset/english/unseen_queries/test"
    unique_query_test_base_path = "/srv/upadro/dataset/english/unseen_queries/unique_query_test"
    for file in files:
